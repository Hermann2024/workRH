...
@Component
public class FactorialConnectorClient {

    private static final String DEFAULT_EMPLOYEES_PATH = "/api/2026-04-01/resources/employees/employees";

    private final RestTemplate restTemplate;

    public FactorialConnectorClient(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    public FactorialSyncResult syncEmployees(HrConnectorConfiguration configuration) {
        ...
        for (JsonNode employee : employees) {
            FactorialEmployee mapped = mapEmployee(employee, configuration.getFieldMappings());
        ...
        return new FactorialSyncResult(importable, skipped, employeesUri.toString());
    }
    ...
    private URI employeesUri(HrConnectorConfiguration configuration) {
        ...
        return UriComponentsBuilder.fromHttpUrl(configuration.getApiBaseUrl())
                ...
                .queryParam("only_active", configuration.getApiSettings().getOrDefault("onlyActive", "true"))
                .build()
                .toUri();
    }
    ...
    private FactorialEmployee mapEmployee(JsonNode employee, Map<String, String> fieldMappings) {
        return new FactorialEmployee(
    ...
    public record FactorialSyncResult(int importableRecords, int skippedRecords, String sourceUrl) {
    }

    private record FactorialEmployee(
            String employeeId,
            String firstName,
            String lastName,
            String email,
