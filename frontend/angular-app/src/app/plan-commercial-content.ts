...
export const PLAN_COMMERCIAL_CONTENT: Record<CommercialPlanCode, PlanCommercialContent> = {
  STARTER: {
    ...
    businessValue: [
      ...
      'Coût maîtrisé pour une équipe de 1 à 10 collaborateurs.'
    ],
    serviceBundle: [
  ...
  PRO: {
    ...
    idealFor: 'Entreprises de 10 à 50 salariés avec frontaliers FR, BE ou DE et besoin de supervision RH active.',
    businessValue: [
    ...
    addOns: ['Export avancé déjà activable', 'SMS', 'Audit déclaratif selon montée en gamme']
  },
  PREMIUM: {
    ...
    businessValue: [
      ...
      'Exports comptables et notifications SMS pour industrialiser les opérations.',
      'Accompagnement onboarding et niveau de service renforcé.'
    ],
    serviceBundle: [
      'Convient aux équipes de 50 collaborateurs et plus.',
  ...
  ENTERPRISE: {
    headline: 'Une offre contractuelle sur mesure pour exigences d’intégration, gouvernance et hébergement.',
    idealFor: 'Groupes, ETI ou contextes sensibles nécessitant un cadrage commercial et technique spécifique.',
    businessValue: [
      'Cadre de prix et de déploiement personnalisable.',
      'Possibilité d’architecture, sécurité et intégration adaptées au contexte client.',
      'Voie naturelle pour demandes spécifiques non couvertes par le catalogue standard.'
    ],
    serviceBundle: [
      'Construction d’un périmètre personnalisé avec l’équipe commerciale.',
      'Trajectoire possible vers SSO, sécurité renforcée et développements dédiés.',
